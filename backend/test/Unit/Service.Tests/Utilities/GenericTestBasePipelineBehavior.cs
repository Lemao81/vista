...
{
	public override Task<Result> Handle(TestRequest request, RequestHandlerDelegate<Result> next, CancellationToken cancellationToken) =>
...
{
	public override Task<Result<TestResponse>> Handle(
		TestRequest                                  request,
