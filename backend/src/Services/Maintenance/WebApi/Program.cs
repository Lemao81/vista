...
try
{
	...
	{
		logger.LogInformation("CONSOLEWRITETESTCONSOLEWRITETESTCONSOLEWRITETESTCONSOLEWRITETESTCONSOLEWRITETESTCONSOLEWRITETEST");
#if RELEASE
		logger.LogInformation("RELEASERELEASERELEASERELEASERELEASERELEASERELEASERELEASERELEASERELEASERELEASERELEASERELEASE");
#endif
#if TEST
		logger.LogInformation("TESTTESTTESTTESTTESTTESTTESTTESTTESTTESTTESTTESTTESTTESTTESTTESTTESTTESTTESTTESTTESTTESTTEST");
#endif
